...
export const metadata = {
  ...
  openGraph: {
    ...
    url: `${process.env.NEXT_PUBLIC_SITE_URL}/details/projects`, // Update with the correct URL
    images: [
      {
        url: `${process.env.NEXT_PUBLIC_SITE_URL}/images/proj.png`, // Update with a relevant image
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [`${process.env.NEXT_PUBLIC_SITE_URL}/images/proj.png`], // Update with a relevant image
  },
};
